package com.okala.test.utils.customview.curve;
...
public class CurveLayout extends ShapeOfView {
    ...
    public CurveLayout(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public CurveLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CurveLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CurveLayout);
            arcHeight = attributes.getDimensionPixelSize(R.styleable.CurveLayout_arc_height, arcHeight);
            arcPosition = attributes.getInteger(R.styleable.CurveLayout_arc_position, arcPosition);
            cropDirection = attributes.getInteger(R.styleable.CurveLayout_arc_cropDirection, cropDirection);
            attributes.recycle();
        }
