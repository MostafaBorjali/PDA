...
public class ScannerOverlay extends ViewGroup {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        rectWidth = this.getWidth() / 2;
        rectHeight = this.getWidth() / 2;
        left = rectWidth / 2;
        top = rectHeight / 4;
        endY = top;
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // RectF rect = new RectF(left / 2, top + 1, this.getWidth() - rectWidth / 4, rectHeight + 2);
        RectF rect = new RectF(left, top, this.getWidth() -rectWidth/2, rectHeight);
        // RectF rect = new RectF(left/2, top, this.getWidth() -rectWidth/4, 400);
